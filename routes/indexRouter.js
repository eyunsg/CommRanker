...
// async function getFundData1(fundName1, fundName2, fundCount1, fundCount2) {
//   const puppeteer = require("puppeteer");
...
//   await page.waitForSelector("#fundNm");
//   await page.type("#fundNm", fundName1, {
//     delay: 100,
//   });
...
//     const result = [];
//     for (let i = 0; i < fundNames.length && result.length < fundCount1; i++) {
//       const fundName = fundNames[i]?.textContent.trim();
...
//     const result = [];
//     for (let i = 0; i < fundNames.length && result.length < fundCount2; i++) {
//       const fundName = fundNames[i]?.textContent.trim();
